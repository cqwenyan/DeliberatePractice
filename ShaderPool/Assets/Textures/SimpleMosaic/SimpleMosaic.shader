...
////// Lighting:
////// Emissive:
                float2 node_5746 = floor(i.uv0 * _node_2375) / (_node_2375 - 1);
                float4 _MainTex_var = tex2D(_MainTex,TRANSFORM_TEX(node_5746, _MainTex));
